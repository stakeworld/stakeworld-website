...
slug: /rpc
sidebar_position: 4
keywords: [rpc, wss, ws, polkadot.js, validator, polkadot, kusama]
---

:::tip
RPC servers allow access into the polkadot/kusama ecosystem. Stakeworld runs two public, multi location, load balanced archive RPC servers; [dot-rpc.stakeworld.io](https://polkadot.js.org/apps/?rpc=wss://dot-rpc.stakeworld.io) and [ksm-rpc.stakeworld.io](https://polkadot.js.org/apps/?rpc=wss://ksm-rpc.stakeworld.io)  
:::
...
There are multiple options for getting a ssl certificate, one popular (and free) being letsencrypt. There are multiple ways of obtaining a letsencrypt certificate, a popular being certbot but we are using [lego](https://go-acme.github.io/lego/dns/) which has more dns provider option.

#### Add the proxy to the apache2 config
In a virtualhost add:
...
### Stress testing your RPC server
