...
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 24808394 | 553G | 577G |
| [direct link](http://snapshot.stakeworld.io/paritydb-paseo.lz4) | paseo | paritydb | pruned | 5223769 | 77G | 82G |
