...
Last update: Thu 14 Nov

|  | Chain    | Database   | Format | Blockheight | Snapshot | Full         | 
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-ksmcc3.lz4) | ksmcc3 | paritydb | pruned | 25769762 | 536G | 558G |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 23402012 | 472G | 492G |
| [direct link](http://snapshot.stakeworld.io/paritydb-unknown.lz4) | unknown | paritydb | pruned | 3819851 | 472G | 492G |
