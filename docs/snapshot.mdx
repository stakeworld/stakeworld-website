...
Last update: Thu 11 Apr

|  | Chain    | Database   | Format | Blockheight | Snapshot | Full         | 
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-ksmcc3.lz4) | ksmcc3 | paritydb | pruned | 22684681 | 399G | 414G |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 20289987 | 342G | 356G |
| [direct link](http://snapshot.stakeworld.io/rocksdb-polkadot.lz4) | polkadot | rocksdb | pruned | 20290400 | 340G | 358G |
| [direct link](http://snapshot.stakeworld.io/rocksdb-ksmcc3.lz4) | ksmcc3 | rocksdb | pruned | 22685978 | 391G | 417G |
