...
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 24635907 | 543G | 567G |
| [direct link](http://snapshot.stakeworld.io/paritydb-paseo.lz4) | paseo | paritydb | pruned | 5051512 | 73G | 78G |
