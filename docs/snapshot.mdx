...
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 24578446 | 540G | 563G |
| [direct link](http://snapshot.stakeworld.io/paritydb-paseo.lz4) | paseo | paritydb | pruned | 4993928 | 72G | 77G |
