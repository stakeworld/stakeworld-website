...
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 24722236 | 548G | 572G |
| [direct link](http://snapshot.stakeworld.io/paritydb-paseo.lz4) | paseo | paritydb | pruned | 5137383 | 75G | 80G |
