...
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 24894433 | 558G | 582G |
| [direct link](http://snapshot.stakeworld.io/paritydb-paseo.lz4) | paseo | paritydb | pruned | 5310112 | 79G | 84G |
