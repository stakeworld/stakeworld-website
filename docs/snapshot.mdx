...
An example systemctl service file can be found here: [`yourvalidator.service`](/files/yourvalidator.service). 
Copy to `/etc/systemd/system` and of course change `--name`, `--chain` and `--database` to your preference.

|  | Chain    | Database   | Format | Blockheight | Size       | Full         | Creation date     |
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ | -------- |
| [direct link](http://snapshot.stakeworld.nl/rocksdb-ksmcc3.lz4) | ksmcc3 | rocksdb | pruned | 15578927 | 154G | 164G | Fri 02 Dec @ 07:30 |
| [direct link](http://snapshot.stakeworld.nl/paritydb-ksmcc3.lz4) | ksmcc3 | paritydb | pruned | 15578926 | 154G | 160G | Fri 02 Dec @ 07:30 |
| [direct link](http://snapshot.stakeworld.nl/rocksdb-polkadot.lz4) | polkadot | rocksdb | pruned | 13176663 | 110G | 116G | Fri 02 Dec @ 07:30 |
| [direct link](http://snapshot.stakeworld.nl/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 13176663 | 110G | 114G | Fri 02 Dec @ 07:30 |
| | ksmcc3 | paritydb | archive | 15489825 | | 1.1T | Fri 02 Dec @ 07:30 |
| | polkadot | paritydb | archive | 13176663 | | 696G | Fri 02 Dec @ 07:30 |
