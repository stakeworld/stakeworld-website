...
Last update: Sun 28 May

|  | Chain    | Database   | Format | Blockheight | Snapshot | Full         | 
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.nl/paritydb-ksmcc3.lz4) | ksmcc3 | paritydb | pruned | 18102164 | 241G | 249G |
| [direct link](http://snapshot.stakeworld.nl/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 15712496 | 184G | 190G |
| | ksmcc3 | paritydb | archive | 18102354 | | 1.6T |
| | polkadot | paritydb | archive | 15712581 | | 1.1T |
| | westend2 | paritydb | archive | 16011261 | | 277G |
