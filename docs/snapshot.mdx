...
Last update: Thu 07 Dec

|  | Chain    | Database   | Format | Blockheight | Snapshot | Full         | 
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ |
| [direct link](http://snapshot.stakeworld.io/paritydb-ksmcc3.lz4) | ksmcc3 | paritydb | pruned | 20876680 | 339G | 352G |
| [direct link](http://snapshot.stakeworld.io/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 18487924 | 273G | 283G |
| [direct link](http://snapshot.stakeworld.io/rocksdb-polkadot.lz4) | polkadot | rocksdb | pruned | 18455332 | 273G | 285G |
| [direct link](http://snapshot.stakeworld.io/rocksdb-ksmcc3.lz4) | ksmcc3 | rocksdb | pruned | 20844032 | 330G | 348G |
