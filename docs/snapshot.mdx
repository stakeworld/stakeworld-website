...
| ------------------------| ----------- | -------- | ------- | ----------- | ---------- | ------------ | -------- |
| [direct link](http://snapshot.stakeworld.nl/paritydb-ksmcc3.lz4) | ksmcc3 | paritydb | pruned | 17829787 | 232G | 241G | Tue 09 May @ 02:22 |
| [direct link](http://snapshot.stakeworld.nl/paritydb-polkadot.lz4) | polkadot | paritydb | pruned | 15439100 | 177G | 182G | Tue 09 May @ 02:32 |
| | ksmcc3 | paritydb | archive | 17829976 | | 1.5T | Tue 09 May @ 02:41 |
| | polkadot | paritydb | archive | 15439185 | | 1022G | Tue 09 May @ 02:41 |
| | westend2 | paritydb | archive | 15740209 | | 270G | Tue 09 May @ 02:41 |
...
In the future this will probably become the default for syncing a database and snapshots may become obsolete.

For now the snapshots are available for kusama `--chain ksmcc3` and polkadot `--chain polkadot` in the paritydb `--database paritydb` database format. They are pruned with `--state-pruning 1000`, which is sufficient for a validator node.
:::
